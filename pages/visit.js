...
export default function Visit({ setValue, setSelectedIndex }) {
  ...
  return (
    ...
    >
      <Head>
        <title key="title">Visit Our School! | Fox Tree Kids</title>
        <meta
          name="description"
          key="description"
          content="Spend half a day with us in the Children's House to fully experience the environment with your child. You will spend the morning session with us and will have the opportunity to ask more questions whilst seeing your child enjoy the environment, do some activities and interact with the other pupils. Register for a visit now!"
        />
        <meta
          property="og:title"
